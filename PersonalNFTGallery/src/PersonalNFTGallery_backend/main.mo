...
shared actor class PersonalNFTGallery(custodian: Principal, init : Types.Dip721NonFungibleToken) = Self {
...
// Project-specific functions
  ...
  func getGalleryTemplateHtmlParts() : [Text] {
    ...
    // TODO: description (<p>Lorem ipsum .</p>)
    ...
    let templateBodyGalleryImage = "<div class='responsive'> <div class='gallery'> <a target='_blank' href=''> <img src='' alt='Cool NFT' width='600' height='400'> </a> <button type='button' class='collapsible'>See Details</button> <div class='content'> <p>Lorem ipsum .</p> </div> </div> </div>";
