...
/***/ "./src/declarations/newwave/index.js":
/*!*******************************************!*\
  !*** ./src/declarations/newwave/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _newwave_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "newwave": () => (/* binding */ newwave)
/* harmony export */ });
...
/* harmony import */ var _newwave_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./newwave.did.js */ "./src/declarations/newwave/newwave.did.js");
...
const canisterId = "qvhpv-4qaaa-aaaaa-aaagq-cai";
 ...
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_newwave_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
 ...
 */
 const newwave = createActor(canisterId);


/***/ }),

/***/ "./src/declarations/newwave/newwave.did.js":
/*!*************************************************!*\
  !*** ./src/declarations/newwave/newwave.did.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/*!***************************************!*\
  ...
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/newwave */ "./src/declarations/newwave/index.js");
...
document.querySelector("form").addEventListener("submit", async (e) => {
  ...
  const entity = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.create_entity(entityToCreate);
  console.log('entity');
  console.log(entity);
  const entityId = entity.internalId;
  console.log('entityId');
  console.log(entityId);
  const retrievedEntity = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_entity(entityId);
  ...
  const entity2 = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.create_entity(entityToCreate2);
  console.log('entity2');
  console.log(entity2);
  ...
  const bridge = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.create_bridge(bridgeToCreate);
  console.log('bridge');
  console.log(bridge);
  console.log('bridge internalId');
  console.log(bridge.internalId);
  const retrievedBridge = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridge(bridge.internalId);
  ...
  console.log(bridgeIdsForEntityNone);
  const bridgeIdsForEntityFrom = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridge_ids_by_entity_id(entityId, true, false, false);
  console.log('bridgeIdsForEntityFrom');
  console.log(bridgeIdsForEntityFrom);
  const bridgeIdsForEntityTo = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridge_ids_by_entity_id(entityId, false, true, false);
  console.log('bridgeIdsForEntityTo');
  console.log(bridgeIdsForEntityTo);
  const bridgeIdsForEntityTo2 = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridge_ids_by_entity_id(entityId2, false, true, false);
  console.log('bridgeIdsForEntityTo2');
  console.log(bridgeIdsForEntityTo2);
  const bridgeIdsForEntityPending = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridge_ids_by_entity_id(entityId, false, false, true);
  console.log('bridgeIdsForEntityPending');
  console.log(bridgeIdsForEntityPending);
  const bridgeIdsForEntityNoPending = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridge_ids_by_entity_id(entityId, true, true, false);
  console.log('bridgeIdsForEntityNoPending');
  console.log(bridgeIdsForEntityNoPending);
  const bridgeIdsForEntityAll = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridge_ids_by_entity_id(entityId, true, true, true);
  console.log('bridgeIdsForEntityAll');
  console.log(bridgeIdsForEntityAll);
  const bridgesForEntityAll = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridges_by_entity_id(entityId, true, true, true);
  ...
  const createEntityAndBridgeTo = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.create_entity_and_bridge(entityToCreate3, bridgeToCreate3);
  ...
  const createEntityAndBridgeFrom = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.create_entity_and_bridge(entityToCreate4, bridgeToCreate4);
  console.log('createEntityAndBridgeFrom');
  console.log(createEntityAndBridgeFrom);
  const getBridgedEntitiesByEntityId = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_bridged_entities_by_entity_id(entityId, true, true, true);
  console.log('getBridgedEntitiesByEntityId');
  console.log(getBridgedEntitiesByEntityId);
  const getEntityAndBridgeIds = await _declarations_newwave__WEBPACK_IMPORTED_MODULE_0__.newwave.get_entity_and_bridge_ids(entityId, true, true, true);
